        ...
        "/images/filter": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "起始时间（YYYY-MM-DD 或 RFC3339）",
                        "name": "start",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "结束时间（YYYY-MM-DD 或 RFC3339）",
                        "name": "end",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.createPointRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.StartDetectRequest": {
            ...
            "properties": {
                ...
                "device": {
                    "description": "设备：cpu/cuda:0/mps，默认空（由YOLO自动选择）",
                    "type": "string"
                },
                "iou": {
